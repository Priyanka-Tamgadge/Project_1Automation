...
public class MenMenu {
    ...
    public MenMenu(WebDriver idriver)
	{
		driver=idriver;
...
/*  -----------  Method for level_1_level_2_SubMenu (after performing MouseHover Operation on MenMenu ---- 
      Tops - Jackets , Hoodies & Sweat shirts , Tees ,Bras & Tanks.
      Bottoms - Pants , Shorts.  ---------------	   */
	   ...
	   //  Verify_MenMenu_PageTitle
	    public void Verify_MenMenu_PageTitle(String expectedTitle) throws InterruptedException
	   {
		   String actualTitle=driver.getTitle();
			if(expectedTitle.equals(actualTitle)) {
				System.out.println("We are on MenMenu Page");
				}
			else
			{
				System.out.println("We are not on the desired Page");
...
//-----------  Method for "SideBar" Options available inside Men's Menu  ---------------
	   
	    //  Verify_SideBar_MenMenuMenMenuPage
	    public void Verify_SideBar_MenMenuPage() throws InterruptedException
	   {
		    System.out.println("\n*SideBar Options:  ");
